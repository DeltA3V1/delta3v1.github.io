...
export function TransitMap() {
  return (
    <section id="transit-map" className="relative h-280 pt-48 pb-48 flex flex-col items-center transition-colors duration-300">
      <svg
      ...
      <div className="bg-dominant w-50 h-14 mb-16 border-2 rounded flex justify-center items-center z-10">
